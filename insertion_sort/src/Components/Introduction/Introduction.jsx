    ...
    return (
        <div className='sm:flex justify-around pb-5 h-3/5 static'>
            <div className='m-0 p-2 sm:p-5 h-3/5 inline-block'>
                <h1 className=" text-base sm:text-3xl font-semibold sm:mt-5 sm:mb-4 text-center text-slate-500 ">Data Structures and Algorithms</h1>
                <p className=" text-base sm:text-xl font-light leading-relaxed mt-2 sm:mt-8 mb-4 text-stone-800">
