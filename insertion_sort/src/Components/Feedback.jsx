...
const Feedback=()=>{
    return (
        ...
        <div className='flex justify-around pb-2'>
            ...
            <img className="h-64 w-102 m-5 mt-20" src={feedback}></img>
            </div>
        <button className="ml-10 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
